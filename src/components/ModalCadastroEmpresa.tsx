...
import {
  ...
  export const ModalCadastroEmpresa = ({ isOpen, onClose }: ModalCadastroEmpresaProps) => {
    ...
    const [frenteDeTrabalhoIds, setFrenteDeTrabalhoIds] = useState<number[]>([])
        ...
        <ModalContent>
          ...
          <ModalBody pb={6}>
            <FormControl mb={3}>
              ...
              <Input ref={initialRef} value={nome} onChange={(e) => setNome(e.target.value)} placeholder='Nome da empresa' />
            </FormControl>
            ...
            <FormControl mb={3}>
              ...
              <Input type='date' value={dataAssinaturaContrato} onChange={(e) => setDataAssinaturaContrato(e.target.value)} />
            </FormControl>
            ...
            <FormControl>
              ...
              <Select
                ...
                onChange={(e) => setFrenteDeTrabalhoIds([parseInt(e.target.value)])}
              >
